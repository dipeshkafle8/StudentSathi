  ...
  return (
    <>
      <div className="flex justify-center">
        <div className="mt-32 w-[80%] pl-10 shadow-lg border-[1px] border-[rgb(227,225,225)] rounded-md">
          {" "}
          <h1 className="text-4xl font-bold mb-6 text-center">{title}</h1>
          <div
            key="1"
            className="flex flex-col md:flex-row items-start gap-8 pt-5"
          >
            ...
            <div className="w-full md:w-1/2">
              <p className="text-lg mb-4">{des}</p>
